...
class TeacherProfileListRegressionTestCase(TestCase):
    def setUp(self):
        ...
        self.teacher_user, _ = self.builder.create_teacher_account(
            ...
            username="teacher-teacher-list",
            password="Teacher@123",
            email="teacher-teacher-list@example.com",
        )
        self.institute_admin_user, _ = self.builder.create_institute_admin_account(
            institute=self.context["institute"],
            username="institute-teacher-list",
            password="Institute@123",
            email="institute-teacher-list@example.com",
        )

    def test_teacher_list_rejects_teacher_scope(self):
        client = APIClient()
    ...
    def test_teacher_list_loads_for_institute_admin_scope(self):
        client = APIClient()
        ...
        self.assertEqual(
            ...
            self.context["teacher"].full_name,
        )
