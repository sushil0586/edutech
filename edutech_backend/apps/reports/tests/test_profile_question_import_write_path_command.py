...
from apps.reports.management.commands.profile_question_import_write_path import Command


class ProfileQuestionImportWritePathCommandTestCase(SimpleTestCase):
