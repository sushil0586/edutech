...
void invalidateTeacherExamList(
  WidgetRef ref, {
  String? examId,
  ...
  if (examId != null && examId.isNotEmpty) {
    ...
    ref.invalidate(liveExamMonitorProvider(examId));
    ref.invalidate(teacherExamAttemptsProvider(examId));
    ref.invalidate(examLeaderboardProvider(examId));
    ref.invalidate(teacherQuestionAnalysisProvider(examId));
  }
  if (includeDashboard) {
