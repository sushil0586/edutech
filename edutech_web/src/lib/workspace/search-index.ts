...
const workspaceSearchIndex: Record<WorkspaceRole, WorkspaceSearchEntry[]> = {
  ...
  teacher: [
    ...
    { href: "/teacher/reports", title: "Reports", description: "Open the teacher student-level academic reports hub.", keywords: ["reports", "reporting", "subjects", "topics", "results"], section: "Insights" },
