    ...
    <article className="dashboardPanel weakTopicsPanel">
      <div className="studentPageTight">
        ...
        <section className="featurePlaceholder">
          ...
          <p>Add one or more program, subject, or topic rows to define what this package can expose.</p>
          <div className="weakTopicStack">
            {scopes.map((scope, index) => {
              ...
              return (
                <div className="weakTopicRow" key={`${scope.id ?? "new"}-${index}`}>
                  <div style={{ width: "100%" }}>
                  ...
                  <div className="weakTopicMeta">
                    <strong>{scope.is_active ? "Active" : "Inactive"}</strong>
        ...
        <section className="featurePlaceholder">
          ...
          <p>{packages.length} packages currently visible in platform-admin scope.</p>
          <div className="weakTopicStack">
