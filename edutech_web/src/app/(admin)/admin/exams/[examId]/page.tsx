...
async function adminExamSlotCreateAction(formData: FormData) {
  "use server";
  ...
  redirect(`/admin/exams/${examId}?message=${encodeURIComponent("Exam slot created successfully.")}`);
}

async function adminExamSlotUpdateAction(formData: FormData) {
  "use server";
  ...
  if (!examId || !slotId) {
    redirect("/admin/exams?error=Slot%20context%20is%20missing.");
  }
  ...
  redirect(`/admin/exams/${examId}?message=${encodeURIComponent("Exam slot updated successfully.")}`);
}

async function adminExamStudentSlotOverrideAction(formData: FormData) {
  "use server";
  ...
  redirect(`/admin/exams/${examId}?message=${encodeURIComponent("Student slot override updated successfully.")}`);
}
    ...
    <div className="studentPage studentDashboardModern instituteConsolePage instituteExamsPageVivid">
          ...
          <div className="weakTopicStack">
            ...
            <div className="weakTopicRow">
              <div>
                ...
                <span>Use this to quickly detect crowding before students start reporting blocked attempts.</span>
              </div>
              <div className="weakTopicMeta">
      ...
      <section className="dashboardLowerGrid">
        ...
        <article className="dashboardPanel weakTopicsPanel">
          ...
          <form action={adminExamSlotCreateAction} className="builderForm">
            <input name="exam_id" type="hidden" value={detail.id} />
            <div className="builderGrid compact">
              <label className="fieldStack">
                <span>Slot label</span>
                <input
                  defaultValue={`${detail.cohort_name ?? "General"} Slot`}
                  name="slot_label"
            ...
            <div className="resultCardActions examDetailActionGrid">
              <ActionSubmitButton
                className="button buttonPrimary"
                idleLabel="Create Slot"
                pendingLabel="Creating Slot..."
              />
            </div>
          </form>
          <div className="weakTopicStack">
            {detail.access_slots.length ? (
              detail.access_slots.map((slot) => (
                <form action={adminExamSlotUpdateAction} className="weakTopicRow" key={slot.id}>
                  <input name="exam_id" type="hidden" value={detail.id} />
                  ...
                  <div style={{ width: "100%" }}>
                    ...
                    <div className="resultCardActions examDetailActionGrid">
                      <ActionSubmitButton
                        className="button buttonSecondary"
                        idleLabel="Update Slot"
                        pendingLabel="Updating Slot..."
                      />
                    </div>
                  </div>
                </form>
        ...
        <article className="dashboardPanel weakTopicsPanel">
          ...
          {detail.assignment_mode === "selected_students" && detail.assigned_students.length ? (
            <form action={adminExamStudentSlotOverrideAction} className="builderForm">
              <input name="exam_id" type="hidden" value={detail.id} />
              <div className="builderGrid compact">
                <label className="fieldStack">
                  <span>Student</span>
              ...
              <div className="resultCardActions examDetailActionGrid">
                <ActionSubmitButton
                  className="button buttonPrimary"
                  idleLabel="Save Student Override"
