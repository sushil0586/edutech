...
async function updateExamSettingsAction(formData: FormData) {
  ...
  try {
    ...
    redirect(`/teacher/exams/${examId}/builder?error=${encodeURIComponent(message)}`);
  }

  redirect(`/teacher/exams/${examId}/builder?message=${encodeURIComponent("Exam settings updated.")}`);
}
...
async function addSectionAction(formData: FormData) {
  ...
  try {
    ...
    redirect(`/teacher/exams/${examId}/builder?tab=sections&error=${encodeURIComponent(message)}`);
  }

  redirect(`/teacher/exams/${examId}/builder?tab=sections&message=${encodeURIComponent("Section added.")}`);
}
...
async function deleteSectionAction(formData: FormData) {
  ...
  redirect(`/teacher/exams/${examId}/builder?tab=sections&message=${encodeURIComponent("Section removed.")}`);
}
...
async function addQuestionLinkAction(formData: FormData) {
  ...
  try {
    ...
    redirect(`/teacher/exams/${examId}/builder?tab=questions&error=${encodeURIComponent(message)}`);
  }

  redirect(`/teacher/exams/${examId}/builder?tab=questions&message=${encodeURIComponent("Question linked to exam.")}`);
}
...
async function bulkAddQuestionLinksAction(formData: FormData) {
  ...
  if (!questionIds.length) {
    redirect(`/teacher/exams/${examId}/builder?tab=questions&error=${encodeURIComponent("Select at least one question to attach.")}`);
  }
  ...
  redirect(
    `/teacher/exams/${examId}/builder?tab=questions&message=${encodeURIComponent(
...
async function deleteQuestionLinkAction(formData: FormData) {
  ...
  redirect(`/teacher/exams/${examId}/builder?tab=questions&message=${encodeURIComponent("Linked question removed.")}`);
}
...
async function updateQuestionLinkAction(formData: FormData) {
  ...
  redirect(`/teacher/exams/${examId}/builder?tab=questions&message=${encodeURIComponent("Linked question updated.")}`);
}
...
async function updateAssignmentsAction(formData: FormData) {
  ...
  try {
    ...
    redirect(`/teacher/exams/${examId}/builder?tab=assignment&error=${encodeURIComponent(message)}`);
  }

  redirect(`/teacher/exams/${examId}/builder?tab=assignment&message=${encodeURIComponent("Student assignment updated.")}`);
}
...
async function updateStudentAccommodationAction(formData: FormData) {
  ...
  redirect(
    `/teacher/exams/${examId}/builder?tab=assignment&message=${encodeURIComponent(
...
async function createExamSlotAction(formData: FormData) {
  ...
  redirect(`/teacher/exams/${examId}/builder?tab=assignment&message=${encodeURIComponent("Exam slot created.")}`);
}
...
async function updateExamSlotAction(formData: FormData) {
  ...
  redirect(`/teacher/exams/${examId}/builder?tab=assignment&message=${encodeURIComponent("Exam slot updated.")}`);
}
...
async function updateStudentSlotOverrideAction(formData: FormData) {
  ...
  redirect(`/teacher/exams/${examId}/builder?tab=assignment&message=${encodeURIComponent("Student slot override saved.")}`);
}
...
async function bulkAssignStudentSlotAction(formData: FormData) {
  ...
  redirect(`/teacher/exams/${examId}/builder?tab=assignment&message=${encodeURIComponent("Bulk student slot assignment saved.")}`);
}
...
async function autoAssignStudentSlotsAction(formData: FormData) {
  ...
  redirect(`/teacher/exams/${examId}/builder?tab=assignment&message=${encodeURIComponent("Automatic slot assignment completed.")}`);
}
        ...
        <article className="dashboardPanel builderPanel">
          <div className="builderPanelHeader">
            <div>
              ...
              <p>Review the teacher-scoped question inventory tied to this exam’s program and subject before attaching items.</p>
            </div>
            <div className="builderPanelMetrics">
              <article className="builderMetricChip">
          ...
          <section className="contentCard">
            ...
            <form action={updateExamSettingsAction} className="builderForm builderWorkspace">
              ...
              <label className="fieldStack">
                ...
                <small>Useful for long-window public exams where starts should be paced across the day.</small>
              </label>
              ...
              <label className="fieldStack">
                ...
                <small>Use this to smooth burst traffic without switching the exam back into slots.</small>
              </label>
              ...
              <label className="fieldStack">
                ...
                <input
                  ...
                  type="number"
                />
                <small>Blocks new starts once too many learners are actively in progress at the same time.</small>
              </label>

              <label className="fieldStack">
                <span>Rank visibility</span>
                <select defaultValue={detail.rank_visibility_mode} name="rank_visibility_mode">
              ...
              <label className="fieldStack">
                ...
                <select defaultValue={detail.percentile_visibility_mode} name="percentile_visibility_mode">
              ...
              <label className="fieldStack">
                ...
                <select defaultValue={detail.benchmark_visibility_mode} name="benchmark_visibility_mode">
              ...
              <label className="fieldStack">
                ...
                <select defaultValue={detail.rank_freeze_policy} name="rank_freeze_policy">
                ...
                <small>
                  Use provisional visibility only when you are comfortable with rank and percentile moving while the exam is still open.
                </small>
              </label>
                </div>
              </section>
