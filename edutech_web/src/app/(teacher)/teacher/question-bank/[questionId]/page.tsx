      ...
      <section className="studentPage studentPageTight studentDashboardModern">
        <section className="studentInsightHeroCard">
          <div className="studentInsightHeroCopy">
            ...
            <p>
              Tags and attachments make this question easier to discover, review, and reuse later inside exam builders,
              without crowding the core editor with secondary content.
            </p>
            <small>
