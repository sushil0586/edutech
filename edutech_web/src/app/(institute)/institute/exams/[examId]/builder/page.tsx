          ...
          <div className="builderStack">
            ...
            {!activeExamQuestions.length ? (
              <div className="builderEmptyState">
                ...
                <p>Choose from the institute question bank below and start building the live paper order.</p>
              </div>
            ) : null}
          </div>
    ...
    <div className="studentPage studentDashboardModern">
      ...
      <section className="studentInsightHeroCard">
        <div className="studentInsightHeroCopy">
          ...
          <p>
            The builder is the central institute workflow for exam authoring. Keep settings, sections,
