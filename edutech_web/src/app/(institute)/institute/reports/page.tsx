...
type InstituteReportLane = "all" | "publication" | "performance" | "weak_topics" | "students";
type InstituteReportSortOption =
  | "recommended"
  | "backlog_high"
  | "score_low"
  | "score_high"
...
function resolveReportLane(value?: string): InstituteReportLane {
  return resolveFilterValue(value, ["publication", "performance", "weak_topics", "students"], "all");
}

function resolveReportSortOption(value?: string): InstituteReportSortOption {
  return resolveFilterValue(value, ["backlog_high", "score_low", "score_high", "attempts_high"], "recommended");
}

function buildInstituteReportHref(args: {
  lane?: InstituteReportLane;
  sort?: InstituteReportSortOption;
  subject?: string;
}) {
  return buildFilterHref("/institute/reports", [
    ["lane", args.lane, "all"],
    ...
    <section className="studentPage studentPageTight studentDashboardModern instituteConsolePage instituteSupportPageVivid">
      ...
      <section className="studentInsightHeroCard studentInsightHeroCardCompact">
        <div className="studentInsightHeroCopy">
          ...
          <strong>Institute reporting overview</strong>
          <small>
          ...
          <section className="contentCard workspaceFiltersCard">
            ...
            <form className="workspaceFiltersForm" method="GET">
              ...
              <div className="workspaceFilterActions">
                ...
                <Link className="button buttonSecondary" href="/institute/reports">
                  Reset filters
                </Link>
              </div>
            </form>
            <div className="workspaceFilterQuickRow">
              ...
              <div className="workspaceFilterQuickChips">
                {[
                  { label: "All", href: buildInstituteReportHref({}), active: lane === "all" && sortOption === "recommended" && subjectFilter === "all" },
                  { label: "Pending Publication", href: buildInstituteReportHref({ lane: "publication", sort: "backlog_high", subject: subjectFilter }), active: lane === "publication" },
                  { label: "Lowest Mastery", href: buildInstituteReportHref({ lane: "weak_topics", sort: "score_low", subject: subjectFilter }), active: lane === "weak_topics" && sortOption === "score_low" },
                  { label: "Most Attempts", href: buildInstituteReportHref({ lane: "performance", sort: "attempts_high", subject: subjectFilter }), active: lane === "performance" && sortOption === "attempts_high" },
                  { label: "Top Performers", href: buildInstituteReportHref({ lane: "students", sort: "score_high", subject: subjectFilter }), active: lane === "students" && sortOption === "score_high" },
                ].map((chip) => (
                  <Link
                    key={chip.label}
