...
function reportHref(report: string) {
  if (report === "subjects" || report === "study-recommendations" || report === "time-management") {
    return `/institute/reports/${report}`;
  }
  return "/institute/reports";
}

export default async function InstituteStudentReportDetailPage({
  params,
  searchParams,
}: {
    ...
    return (
      <section className="studentPage studentPageTight studentDashboardModern instituteConsolePage instituteSupportPageVivid instituteReportsPageVivid">
        <InstitutePageHeader
          ...
          description="Institute-scoped learner report detail could not be loaded right now."
  ...
  return (
    <section className="studentPage studentPageTight studentDashboardModern instituteConsolePage instituteSupportPageVivid instituteReportsPageVivid">
      <InstitutePageHeader
        title="Student Report Detail"
        description="Institute-side learner drilldown built from current insight summary signals."
      ...
      <StudentAnalyticsDetailHero
        eyebrow="Institute learner drilldown"
        title={student.student_name}
        description={`Use this learner view to consolidate the current academic support signal, the leading weak-topic pressure, and the best next institute handoffs for ${student.student_name}.`}
        badges={[
        ...
        actions={
          <>
            ...
            <Link className="button buttonGhost" href="/institute/results/attempts">
              Open Attempt Review
            </Link>
          </>
        }
        ...
        items={[
          {
            ...
            note: supportStudent
              ? "Visible in the low-performance institute lane"
              : "Visible in the high-performance institute lane",
      ...
      <section className="studentInsightsTwoColumn">
        <article className="contentCard">
          <div className="sectionHeading">
            <strong>Institute interpretation</strong>
          ...
          <div className="studentInsightMessageStack">
            ...
            <div className="studentInsightMessage">
              ...
              <p>
                ...
                {" · "}
                {topWeakTopic
                  ? `${topWeakTopic.subject_name} / ${topWeakTopic.topic_name ?? "Topic recovery"} is the strongest current institute insight signal.`
                  : "The weak-topic stack has not populated yet for this institute scope."}
              </p>
            </div>
            <div className="studentInsightMessage">
              <span className="placeholderDot" aria-hidden="true" />
              <p>
                ...
                {topWrongQuestion
                  ...
                  : "No wrong-question concentration is available yet in this institute scope."}
              </p>
            </div>
          </div>
        </article>
        ...
        <article className="contentCard">
          <div className="sectionHeading">
            ...
            <span>Institute next steps</span>
          </div>
              ...
              <>
                ...
                <div className="studentInsightMessage">
                  ...
                  <p>
                    ...
                    {" · "}
                    Highest score {currentExam.highest_score} and lowest score {currentExam.lowest_score} in the current institute-visible exam cycle.
                  </p>
                </div>
              </>
            ) : (
              <p className="emptyText">Exam context will appear once the institute insight summary includes an active results cycle.</p>
            )}
          </div>
        </article>
