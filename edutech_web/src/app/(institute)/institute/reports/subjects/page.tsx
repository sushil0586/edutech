...
export default async function InstituteSubjectReportsPage() {
    ...
    return (
      <section className="studentPage studentPageTight studentDashboardModern instituteConsolePage instituteSupportPageVivid instituteReportsPageVivid">
        <InstitutePageHeader
          ...
          description="Institute-scoped student subject reporting could not be loaded right now."
  ...
  return (
    <section className="studentPage studentPageTight studentDashboardModern instituteConsolePage instituteSupportPageVivid instituteReportsPageVivid">
      <InstitutePageHeader
        title="Subject Performance Report"
        description="Institute-scoped student subject signals derived from current weak-topic and student outcome evidence."
      ...
      <StudentAnalyticsDetailHero
        eyebrow="Institute subject performance"
        title="Student subject comparison is available in institute scope"
        description="This report is built from the current institute insight summary. It shows subject-level pressure, weak-topic concentration, and student support lanes while dedicated deeper aggregation can evolve later."
        badges={[
          "Institute-scoped academic signals",
          "Weak-topic driven subject view",
          "Student-level institute supervision",
        ]}
        stats={[
        ...
        actions={
          <>
            <Link className="button buttonPrimary" href="/institute/results/analysis">
              Open Analysis
            </Link>
        ...
        items={[
          {
            ...
            note: "Derived subject signals from institute weak-topic evidence",
            tone: "primary",
          },
          {
          ...
          },
          {
            label: "Current Scope",
            value: "Student level",
            note: "Focused on student academic supervision across institute scope",
          },
        ]}
      />
      ...
      <section className="studentInsightsTwoColumn">
        <article className="contentCard">
          ...
          {subjectRows.length ? (
            ...
            <p className="emptyText">Subject-strength rows will appear when institute weak-topic evidence is available.</p>
          )}
        </article>
          ...
          <div className="studentInsightMessageStack">
            {summary.high_performing_students.slice(0, 6).map((student) => (
              <div className="studentInsightMessage" key={`high-${student.student_id}`}>
                <span className="placeholderDot" aria-hidden="true" />
                <p>
                  <Link href={`/institute/reports/students/${student.student_id}?from=subjects`}>
