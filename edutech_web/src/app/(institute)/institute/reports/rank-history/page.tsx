...
export default async function InstituteRankHistoryReportPage() {
    ...
    return (
      <section className="studentPage studentPageTight studentDashboardModern instituteConsolePage instituteSupportPageVivid instituteReportsPageVivid">
        <InstitutePageHeader
          ...
          description="Institute-wide ranking history could not be loaded right now."
  ...
  return (
    <section className="studentPage studentPageTight studentDashboardModern instituteConsolePage instituteSupportPageVivid instituteReportsPageVivid">
      <InstitutePageHeader
        title="Rank History Report"
        description="Institute-scoped ranking snapshots across result cycles, publication posture, and leaderboard readiness."
      ...
      <StudentAnalyticsDetailHero
        eyebrow="Institute rank history"
        title="Ranking posture is visible across institute result cycles"
        description="Use this report to review which institute result cycles are rank-ready, which are still blocked by publication or review workflow, and where leaderboard follow-up should happen next."
        badges={[
          "Institute ranking snapshots",
        ...
        actions={
          <>
            <Link className="button buttonPrimary" href="/institute/results/leaderboard">
              Open Leaderboard
            </Link>
      ...
      <StudentKpiGrid
        items={[
          ...
          },
          {
            ...
            note: "Result cycles already visible to learners",
          },
          {
          ...
          },
          {
            ...
            note: "Visible ranked result records across institute cycles",
          },
        ]}
      />
      ...
      <section className="studentInsightsTwoColumn">
        ...
        <article className="contentCard">
          ...
          <div className="analyticsChecklist">
            ...
            <div className="analyticsChecklistItem">
              <strong>Use leaderboard for deeper drilldown</strong>
              <span>The leaderboard route remains the best next handoff when you want ranked student-level evidence.</span>
            </div>
          </div>
        </article>
      </section>
