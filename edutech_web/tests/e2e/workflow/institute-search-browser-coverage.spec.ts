...
async function gotoSearch(page: Page, path = "/institute/search?q=exam") {
...
test.describe("Institute search browser functionality coverage", () => {
  ...
  test("@workflow browser coverage keeps institute search controls hydrated", async ({ page }) => {
  ...
  test("@workflow browser coverage can apply and reset institute search filters truthfully", async ({
    page,
  }) => {
    await gotoSearch(page);
  ...
  test("@workflow browser coverage proves institute search no-results state is distinct from normal results", async ({
    page,
  }) => {
    await gotoSearch(page, "/institute/search?q=playwright-definitely-no-match-zzzz&source=live&group=section");
  ...
  test("@workflow browser coverage keeps institute search summary counts internally truthful", async ({
    page,
  }) => {
    await gotoSearch(page);
