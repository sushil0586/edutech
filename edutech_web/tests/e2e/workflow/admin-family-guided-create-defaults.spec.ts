...
test.describe("Admin family guided create defaults", () => {
  test.skip(testRequiresRole("admin"), "Admin Playwright credentials are not configured.");

  test("@workflow admin guided create wizard applies NEET, JEE, GRE, and AWS family defaults from the seeded program lane", async ({
    page,
  }) => {
    ...
    for (const scenario of guidedFamilyScenarios) {
      ...
      await title.fill(`PW Family Guided Defaults ${scenario.presetId}`);
